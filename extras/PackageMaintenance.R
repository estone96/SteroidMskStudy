...
OhdsiRTools::checkUsagePackage("TdexaCpds")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/TdexaCpds.pdf")
shell("R CMD Rd2pdf ./ --output=extras/TdexaCpds.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("TdexaCpds")
