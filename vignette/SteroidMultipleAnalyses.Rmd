...
connectionDetails <- createConnectionDetails(dbms = "sql server", 
                                             server = "166.104.103.150", 
                                             user = "sa", 
                                             password = "humic1234")
connection <- connect(connectionDetails)

cdmDatabaseSchema <- "[NHIS_CDM_Sample].[dbo]"
resultsDatabaseSchema <- "[NHIS_CDM_Sample].[ohdsiresult]"
...
This package analyzes outcomes according to cumulative dose or dose per day. First, determine cutoffpercentile. x in setcutoffPercentile(x) ranges from 0 to 100 and devides the cohort into two groups (upper percentile; 100-x%, lower percentile; x%), this shall be target and comparative groups respectivley. Second, determine PerDay argument. For cumulative dose analysis, put 'false', and for dose per day analysis, put 'true'. In cumulative dose analysis, the dose of steroid prescirbed will calculated and converted to prednisolone dose according to potency of steroids.  
